...
public class Couple_status extends Fragment {
   ...
   // private ArrayList<ImgLoad> imglistcpdp=new ArrayList<>();
    ...
    String databasename="CoupleStatus";
    String storagename="CoupleStatus/";

    public Couple_status() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  Toast.makeText(getContext(), "Couple Status ", Toast.LENGTH_LONG).show();
        ...
        View vv= inflater.inflate(R.layout.fragment_couple_status, container, false);

        arview = vv.findViewById(R.id.cpstatusrecyclerview);
        pbar=vv.findViewById(R.id.progressBar3);
        ...
        final CollectionReference productsRef = db.collection("CoupleStatus");
...
////////////////////
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("CoupleStatus/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
...
//click listner clsoe
    ...
    /*class Rvadpter extends RecyclerView.Adapter<Myviewholder>
    {
        ...
        public Rvadpter(ArrayList<ImgLoad> imglistcp) {
...
//                       prodig2.dismiss();
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(getContext(), "Error" + e.getMessage()+"due to SLOW NETWORK..", Toast.LENGTH_LONG).show();                    // err.setText("error"+e.getMessage());
                }
            });
