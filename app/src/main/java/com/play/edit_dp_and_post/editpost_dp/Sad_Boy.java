...
public class Sad_Boy extends Fragment {
    ...
    String databasename = "SadBoy";
    String storagename = "SadBoy/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Toast.makeText(getContext(), "Sad Boy Dp", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();

        // Inflate the layout for this fragment
        View vv = inflater.inflate(R.layout.fragment_sad__boy, container, false);
        arview = vv.findViewById(R.id.sadboyrecyclerview);
        pbar = vv.findViewById(R.id.progressBar8);
        ...
        final CollectionReference productsRef = db.collection("SadBoy");
        ...
        //arview.setLayoutManager(new GridLayoutManager(getContext(), 3));
        //src of data
        //retrive from firebase
      /*  db.collection("SadBoy")
...
////////////////////
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("SadBoy/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
