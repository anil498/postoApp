...
public class Motivation extends Fragment {
    ...
    String databasename = "Motivation";
    String storagename = "Motivation/";
...
//        Toast.makeText(getContext(), "Motivation Dp", Toast.LENGTH_LONG).show();
        ...
        View vv = inflater.inflate(R.layout.fragment_motivation, container, false);
        pbar = vv.findViewById(R.id.progressBar10);

        arview = vv.findViewById(R.id.motivrecyclerview);
        ...
        final CollectionReference productsRef = db.collection("Motivation");
...
class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
    {
        ...
        //get and load image
        sref.child("Motivation/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
