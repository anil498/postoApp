...
public class Couple_Dp extends Fragment {
   ...
   // private ArrayList<ImgLoad> imglistcpdp=new ArrayList<>();
    String databasename="Couple";
    String storagename="Couple/";
    ...
    {
        //Toast.makeText(getContext(), "Couple Dp ", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();

        // Inflate the layout for this fragment
        View vv = inflater.inflate(R.layout.fragment_couple__dp, container, false);
        arview = vv.findViewById(R.id.cdprecyclerview);
        pbar=vv.findViewById(R.id.progressBar2);
        loadtext=vv.findViewById(R.id.loadtv);
        /////////auro fill grid in recycler view
        int mNoOfColumns=Utility.calculateNoOfColumns(getContext(),150);
        //Toast.makeText(getContext(), "no of columns"+mNoOfColumns+"for 150dp" , Toast.LENGTH_LONG).show();
        ...
        final CollectionReference productsRef = db.collection("Couple");
       ...
       /* db.collection("Couple")
          ...
          // Toast.makeText(getContext(), "all dp image load", Toast.LENGTH_LONG).show();
                    ...
                    for (QueryDocumentSnapshot doc : task.getResult()) {
                        ...
                        imglistcpdp.add(imgobj);

                    }//for close
                        loadtext.setVisibility(View.GONE);
                      // Toast.makeText(getContext(), "No. of image"+imglistcpdp.size(), Toast.LENGTH_LONG).show();


                    //create recycler adapter
                    Rvadpter adp = new Rvadpter(imglistcpdp);
...
////////////////////
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("Couple/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
  ...
  /* class Rvadpter extends RecyclerView.Adapter<Myviewholder>
   {
       ...
       private ArrayList<ImgLoad>imglistcp;



       public Rvadpter(ArrayList<ImgLoad> imglist)
       {
           this.imglistcp = imglist;
       }
       ...
       {   View vv= getLayoutInflater().inflate(R.layout.recent_grid_design,parent,false);
          // View vv = getLayoutInflater().inflate(R.layout.recent_grid_design, parent, false);
           ...
           //Toast.makeText(getContext(), "mv value in on createviewholder " + mv, Toast.LENGTH_LONG).show();
...
//                       prodig2.dismiss();
                       ...
                       Toast.makeText(getContext(), "your phone not support piccaso lib" + e.getMessage(), Toast.LENGTH_LONG).show();
               ...
               @Override
               public void onFailure(@NonNull Exception e) {
                   Toast.makeText(getContext(), "Error " + e.getMessage()+"Due to SLOW NETWORK SPEED ", Toast.LENGTH_LONG).show();
                   // err.setText("error"+e.getMessage());
               }
           });
