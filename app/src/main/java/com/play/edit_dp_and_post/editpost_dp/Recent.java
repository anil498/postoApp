...
public class Recent extends Fragment {
    ...
    String databasename = "Recent";
    String storagename = "Recent/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Toast.makeText(getContext(), "Recent Event Dp", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();

        // Inflate the layout for this fragment
        View vv = inflater.inflate(R.layout.fragment_recent, container, false);
        arview = vv.findViewById(R.id.recentrecyclerview);
        ...
        final CollectionReference productsRef = db.collection("Recent");
...
////////////////////
    ...
    class ProductAdapter extends RecyclerView.Adapter<ProductViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position) {
            ...
            //get and load image
            sref.child("Recent/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
