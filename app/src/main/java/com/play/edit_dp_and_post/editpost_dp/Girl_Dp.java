...
public class Girl_Dp extends Fragment {
   ...
   // private ArrayList<ImgLoad> imglist=new ArrayList<>();
    String databasename = "GirlDp";
    String storagename = "GirlDp/";
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View vv = inflater.inflate(R.layout.fragment_girl__dp, container, false);
        arview = vv.findViewById(R.id.girldprecyclerview);
        pbar=vv.findViewById(R.id.progressBar);
       ...
       // FirebaseFirestore rootRef = FirebaseFirestore.getInstance();
        final CollectionReference productsRef = db.collection("GirlDp");
