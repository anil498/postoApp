...
public class BirthDay extends Fragment {
    ...
    String databasename = "BirthDay";
    String storagename = "BirthDay/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Toast.makeText(getContext(), "Birthday Pic", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();
        //////for progess bar

        View vv = inflater.inflate(R.layout.fragment_birth_day, container, false);
        arview = vv.findViewById(R.id.bdyrecyclerview);
        pbar = vv.findViewById(R.id.progressBar6);
        ...
        final CollectionReference productsRef = db.collection("BirthDay");
        ...
        /*db.collection("BirthDay")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    //Toast.makeText(getContext(), " Birthday image load", Toast.LENGTH_LONG).show();
...
////////////////////
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("BirthDay/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
