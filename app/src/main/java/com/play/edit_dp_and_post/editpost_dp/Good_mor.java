...
public class Good_mor extends Fragment {
    ...
    String databasename = "GoodMorning";
    String storagename = "GoodMorning/";
    //////////
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Toast.makeText(getContext(), "Good Morning Wish Dp... ", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();
        // Inflate the layout for this fragment
        View vv = inflater.inflate(R.layout.fragment_good_mor, container, false);
  //////

   ///////

        arview = vv.findViewById(R.id.gmrecyclerview);
        pbar = vv.findViewById(R.id.progressBar11);
        ...
        final CollectionReference productsRef = db.collection("GoodMorning");
  ...
  return vv;
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("GoodMorning/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
