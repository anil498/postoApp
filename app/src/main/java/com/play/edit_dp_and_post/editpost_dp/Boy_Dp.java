...
public class Boy_Dp extends Fragment {
    ...
    String databasename = "BoyDp";
    String storagename = "BoyDp/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Toast.makeText(getContext(), "Boy Dp", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();

        // Inflate the layout for this fragment
        View vv = inflater.inflate(R.layout.fragment_boy__dp, container, false);

        arviewboyatt = vv.findViewById(R.id.boydprecyclerview);
...
//////////////////
        final CollectionReference productsRef = db.collection("BoyDp");
...
loadtv.setVisibility(View.GONE);
                    ...
                    Rvadpter adp = new Rvadpter(imglistboyatt);
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("BoyDp/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
...
/*class Rvadpter extends RecyclerView.Adapter<Myviewholder>
{
    ...
    public Rvadpter(ArrayList<ImgLoad> imglistboyatt) {
    ...
    public void onBindViewHolder(@NonNull final Myviewholder holder, final int position) {
        ...
        //get and load image
        srefboyatt.child("BoyDp/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
