...
public class God extends Fragment {
    ...
    String databasename = "God";
    String storagename = "God/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //  Toast.makeText(getContext(), "God Dp", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();

        // Inflate the layout for this fragment
        View vv = inflater.inflate(R.layout.fragment_god, container, false);
        arview = vv.findViewById(R.id.godrecyclerview);
        pbar = vv.findViewById(R.id.progressBar9);
        ...
        final CollectionReference productsRef = db.collection("God");
...
////////////////////
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("God/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
