...
public class Sad_girl extends Fragment {
    ...
    String databasename = "SadGirl";
    String storagename = "SadGirl/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //  Toast.makeText(getContext(), "Sad Girl Dp", Toast.LENGTH_LONG).show();

        db = FirebaseFirestore.getInstance();
        sref = FirebaseStorage.getInstance().getReference();

        // Inflate the layout for this fragment
        View vv = inflater.inflate(R.layout.fragment_sad_girl, container, false);
        arview = vv.findViewById(R.id.sadgirlrecyclerview);
        pbar = vv.findViewById(R.id.progressBar7);
        ...
        final CollectionReference productsRef = db.collection("SadGirl");
...
////////////////////
    ...
    class  ProductAdapter extends RecyclerView.Adapter<ProductViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position)
        {
            ...
            //get and load image
            sref.child("SadGirl/" + fimageuri).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
